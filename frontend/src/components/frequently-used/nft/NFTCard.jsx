...
const LightningIcon = styled.span`
  font-size: 16px;
  margin-left: 2px; /* Add margin-left to create spacing between the text and icon */
`;
        ...
        <SquareCardsContainer>
          <SquareCard>
            <SquareCardContent>
              ...
              <SquareCardTitle style={{ color: '#3086d5' }}>Traits 2%</SquareCardTitle>
            </SquareCardContent>
          </SquareCard>
          <SquareCard>
            <SquareCardContent>
